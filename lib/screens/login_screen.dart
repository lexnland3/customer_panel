...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    try {
      await Api.login(email: _email.text.trim(), password: _password.text.trim());
      _goHome();
    } catch (e) {
  ...
  Future<void> _signInWithGoogle() async {
    ...
    try {
      ...
      // Web popup (Flutter Web) — works for mobile too via redirect
      final UserCredential cred =
          await FirebaseAuth.instance.signInWithPopup(provider);

      final User? firebaseUser = cred.user;
      if (firebaseUser == null) throw Exception('Google sign-in failed. Try again.');
      ...
      switch (e.code) {
        ...
        case 'cancelled-popup-request':
          msg = 'Sign-in was cancelled.'; break;
            ...
            Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                const Text('Welcome Back!',
                    style: TextStyle(fontSize: 30, fontWeight: FontWeight.w900, color: Colors.white, height: 1.1)),
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Container(
                    ...
                    child: Row(children: [
                      ...
                      Expanded(child: Text(_error!,
                          style: const TextStyle(color: C.error, fontSize: 13))),
                    ]),
                  ),
                ],
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    prefixIcon: Icon(Icons.email_outlined, color: C.primary),
                  ),
                ),
...
class _GoogleGPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    void arc(double start, double sweep, Color color) {
      canvas.drawArc(arcRect, start, sweep, false,
          Paint()..color = color..style = PaintingStyle.stroke..strokeWidth = strokeW..strokeCap = StrokeCap.butt);
    }
    ...
    final barPaint = Paint()..color = Colors.white..strokeWidth = strokeW * 0.85..strokeCap = StrokeCap.butt;
    canvas.drawLine(
